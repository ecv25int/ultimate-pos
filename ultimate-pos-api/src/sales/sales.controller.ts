...
export class SalesController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns total sales count, revenue, and payment status breakdown for the business.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Creates a sale with line items. Automatically decrements stock for each line.',
  })
  ...
  @ApiOperation({
    summary: 'List sales',
    description: 'Paginated list of sales with optional filters. Max limit: 100.',
  })
  ...
  @ApiQuery({
    name: 'type',
    required: false,
    enum: ['sale', 'sale_return', 'quotation'],
  ...
  @ApiOperation({
    ...
    description: 'Returns items from a sale. Automatically restocks the returned quantities.',
  })
  ...
  convertToInvoice(@Request() req: any, @Param('id', ParseIntPipe) id: number) {
  ...
  update(@Request() req: any, @Param('id', ParseIntPipe) id: number, @Body() dto: UpdateSaleDto) {
